...
CFLAGS=-O3 -D_POSIX_C_SOURCE=200809L -Wall -std=c99 -pedantic
LIBS=-lm -lgsl -lgslcblas

all: scode scode-online scode-logl

scode-logl: scode-logl.o scode-model.o dlib.o
	$(CC) $(CFLAGS) $^ -lm -o $@

scode-logl.o: scode-logl.c dlib.h scode-model.h
	$(CC) -c $(CFLAGS) $< -o $@

scode-model.o: scode-model.c dlib.h scode-model.h
	$(CC) -c $(CFLAGS) $< -o $@

scode-online: scode-online.o scode-model.o dlib.o
	$(CC) $(CFLAGS) $^ -lm -o $@

scode-online.o: scode-online.c dlib.h scode-model.h
	$(CC) -c $(CFLAGS) $< -o $@
